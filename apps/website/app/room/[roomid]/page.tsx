      ...
      try {
        ...
        if (response.data.success) {
          ...
          if (user && response.data.data.interested) {
            setHasReminder(response.data.data.interested.includes(user.privyId));
          }
        } else {
    ...
    try {
      ...
      if (navigator.share) {
        await navigator.share({
          title: 'Join the conversation on Fireside!',
          text: 'Come join the conversation on Fireside!',
          url: roomURL,
        });
      } else {
